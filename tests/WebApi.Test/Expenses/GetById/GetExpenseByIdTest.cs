...
public class GetExpenseByIdTest : CashFlowClassFixture
{
    ...
    public async Task Success()
    {
        ...
        //**************************************************************
        // O IsDefined verifica se o nosso valor está 'dentro' do Enum
        //-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
        // Útil para verificar se um valor faz parte de um enum
        //**************************************************************
    ...
    {
        var result = await DoGet(requestUri: $"{METHOD}/{0}", token: _token, cultureInfo: culture);
