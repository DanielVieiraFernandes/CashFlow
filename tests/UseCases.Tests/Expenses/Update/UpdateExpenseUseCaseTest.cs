...
public class UpdateExpenseUseCaseTest
{
    ...
    public async Task Success()
    {
        ...
        //**********************************************************************************************
        // Como eu estou passando o objeto 'expense' para a classe mock e estou dizendo
        // para ela retornar esse mesmo objeto quando o método GetById for chamado,
        // o caso de uso mapeia os dados do request para esse mesmo objeto,
        // possibilitando com que eu verifique se os dados foram atualizados corretamente
        //**********************************************************************************************
    ...
    public async Task Error_Title_Empty()
    {
        ...
        e.GetErrors()!.Contains(ResourceErrorMessages.TITLE_REQUIRED));
    }
    ...
    public async Task Error_Expense_Not_Found()
    {
        ...
        var act = async () => await useCase.Execute(0, request);

        var result = await act.Should().ThrowAsync<NotFoundException>();

        result.Where(e => e.GetErrors().Count == 1 &&
        e.GetErrors()!.Contains(ResourceErrorMessages.EXPENSE_NOT_FOUND));
    }
